...
$lang['CronTasks.crontask.description.deliver_invoices'] = 'Teslim edilmesi planlanan ödeme makbuzları seçilen aralıkta gönderilecektir.';
$lang['CronTasks.crontask.name.deliver_invoices'] = 'Makbuzları Teslim Edin';
...
$lang['CronTasks.crontask.description.apply_payments'] = 'Gevşek krediler, seçilen aralıkta otomatik olarak açık ödeme makbuzlarına uygulanır.';
$lang['CronTasks.crontask.name.apply_payments'] = 'Ödemeleri Açık Makbuzlara Uygula';
...
$lang['CronTasks.crontask.description.autodebit'] = 'Otomatik ödeme için seçilen ödeme hesapları, açık ödeme makbuzlarının günlük olarak belirtilen zamanda ödenmesi için çalıştırılacaktır.';
$lang['CronTasks.crontask.name.autodebit'] = 'Otomatik Ödeme';
$lang['CronTasks.crontask.description.apply_invoice_late_fees'] = 'Gecikme ücretlerini, vadesi geçtikten yapılandırılmış sayıda gün sonra açık ödeme makbuzlarına uygular.';
$lang['CronTasks.crontask.name.apply_invoice_late_fees'] = 'Fatura Gecikme Ücretlerini Uygula';
$lang['CronTasks.crontask.description.create_invoice'] = 'Yinelenen ödeme makbuzları ve yenilenen hizmetler, günde bir kez belirtilen saatte çalışan bu görev aracılığıyla faturalandırılır.';

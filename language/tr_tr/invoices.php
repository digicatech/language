...
$lang['Invoices.!error.id_format.length'] = 'Ödeme makbuzları için kimlik formatı 64 karakteri geçemez.';
$lang['Invoices.!error.id_format.empty'] = 'Ödeme makbuzları için kimlik formatı ayarlanmadı.';
...
$lang['Invoices.!line_item.service_prorated_upgrade_description_onetime'] = 'Prorated Upgrade from %1$s to %2$s - %3$s';
$lang['Invoices.!line_item.service_prorated_upgrade_description'] = 'Prorated Upgrade from %1$s to %2$s - %3$s (%4$s - %5$s)';
...
$lang['Invoices.!error.invoice_id.unique'] = 'Hedef makbuz, birleştirilecek makbuzların bir parçası olamaz.';
$lang['Invoices.!error.invoice_id.status'] = 'Hedef fatura açık ve herhangi bir işlem yapılmamış olmalıdır.';
$lang['Invoices.!error.invoice_ids.client'] = 'Tüm ödeme makbuzları aynı müşteriye ait olmalıdır.';
$lang['Invoices.!error.invoice_ids.status'] = 'Tüm ödeme makbuzları açık ve herhangi bir işlem yapılmamış olmalıdır.';
$lang['Invoices.!error.invoice_ids.currency'] = 'Tüm ödeme makbuzları aynı para birimine sahip olmalıdır.';
